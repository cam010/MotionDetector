...
class CustomScale(ttk.Scale):
    def __init__(self, master=None, **kw):
        ...
        ttk.Scale.__init__(self, master, variable=self.variable, style="Horizontal.TScale", **kw)
    ...
    def _update_text(self, *args):
        print(round(self.variable.get()))
        pass
        # style.configure(self._style_name, text="{:.1f}".format(self.variable.get()))

# trough = os.path.join("images", "trough2.png")
trough = "trough2.png"
...
img_trough = tk.PhotoImage(master=root, file=trough)
...
style.configure("Horizontal.TScale", bd="green", background="yellow")
